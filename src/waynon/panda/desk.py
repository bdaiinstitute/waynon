...
class Desk:
    ...
    async def system_state_generator(self):            
    ...
    @trio_async_generator
    async def general_system_status_generator(self):            
        # Example
        # controlToken
        # {activeToken: {id: 922130033, ownedBy: "admin"}, fciActive: false, tokenRequest: null}
        # derived : 
        # {operatingMode: "Execution", desiredColor: {color: "Blue", mode: "Constant"},…}
        # execution: 
        # {aborted: false, error: null, errorHandling: false, lastActivePath: null, remainingWaitTime: null,…}
        # processes: 
        # "Up"
        # robot: 
        # {closeToSingularity: false,…}
        # safety: 
        # {sequenceNumber: 842683, safetyControllerStatus: "Work",…}
        # startup: 
        # {tag: "Started"}
    ...
    @trio_async_generator
    async def safety_status_generator(self):            
        # {
        #   "sequenceNumber":856226,
        #    "safetyControllerStatus":"Work",
        #    "brakeState":["Locked","Locked","Locked","Locked","Locked","Locked","Locked"],
        #    "stoState":"SafeTorqueOff",
        #    "timeToTd2":78035,
        #    "activeWarnings":{"safetySettingsInvalidated":false,"temperatureHigh":false},
        #    "demandedRecoveries":{
        #       "jointLimitViolation":[false,false,false,false,false,false,false],
        #       "jointPositionError":[false,false,false,false,false,false,false],
        #       "safetyRuleViolationsConfirmation":{},
        #       "safetyRuleViolationsRecovery":{}
        #     },"recoverableErrors":{"environmentDataTimeout":false,"fsoeConnectionError":false,"genericJointError":false,"guidingEnablingDevice":false,"jointPositionError":false,"safeInputErrorX31":false,"safeInputErrorX32":false,"safeInputErrorX33":false,"safeInputErrorX4":false,"td2Timeout":false},"activeRecovery":null,"safeInputState":{"guidingEnableButton":"Inactive","x31":"Active","x32":"Inactive","x33":"Inactive","x4":"Inactive"},"powerState":{"endEffector":"On","robot":"On"},"safetyControllerStatusReason":{"conflictingInputs":false,"fsoeWatchdogError":false,"sacoVersionMismatch":false,"nonRecoverableSafetyError":false,"temperatureError":false,"connectionToSafetySettingsManagerLost":false,"environmentDataMissing":false,"jointsSafetyError":[false,false,false,false,false,false,false],"safetyVersionMismatch":false},"safetyConfigurationIndex":3,"fsoeConnectionStatus":["Data","Data","Data","Data","Data","Data","Data"]}
